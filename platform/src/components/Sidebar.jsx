      ...
      <nav class="nav">
        ...
        <div class="nav-block">
          ...
          <div class="nav-section-content">
            <div class="nav-section-list">
              ...
              <button class={`nav-item nav-item-sub ${view === 'eve-ng-sim' ? 'active' : ''}`} onClick={() => onNavigate('eve-ng-sim')}>📦 Simulateur EVE-NG (lab)</button>
        ...
        <div class="nav-block">
          ...
          <button class={`nav-item ${view === 'progression' ? 'active' : ''}`} onClick={() => onNavigate('progression')}>📊 Progression</button>
            <button class={`nav-item ${view === 'options' ? 'active' : ''}`} onClick={() => onNavigate('options')}>⚙️ Options</button>
        </div>
